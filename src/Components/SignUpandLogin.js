                ...
                <div className={`containersnl ${isSignUp ? 'right-panel-active' : 'left-panel-active'}`}>
                    <div className="form-container sign-up-container">
                        <form action="/" id='signupform' className='form'>
                            ...
                            <div className="social-container">
                                <a href="/" className="a social"><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="blue" class="bi bi-facebook" viewBox="0 0 16 16">
                                ...
                                <a href="/" className="a social"><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="red" class="bi bi-google" viewBox="0 0 16 16">
                                ...
                                <a href="/" className="a social"><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="blue" class="bi bi-linkedin rounded-circle" viewBox="0 0 16 16">
                            ...
                            <input type="text" placeholder="Name*" id='username' required="true" className='ip' />
                            <input type="email" placeholder="Email*" id='email' required="true" className='ip' />
                            <input type="password" placeholder="Password*" id='password' required="true" className='ip' />
                    ...
                    <div className="form-container sign-in-container">
                        <form action="/" className='form'>
                            ...
                            <input type="email" placeholder="Email*" id='email1' required="true" className='ip' />
                            <input type="password" placeholder="Password*" id='password1' required="true" className='ip' />
